...
final userPool =
    new CognitoUserPool(secret.cognitoUserPoolId, secret.cognitoClientId);
...
class UserService {
  ...
  Future<CognitoCredentials> getCredentials() async {
    ...
    credentials =
        new CognitoCredentials(secret.cognitoIdentityPoolId, _userPool);
...
class SecureCounterApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: HomePage(title: 'Recipe App'),
    );
  }
}
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  _submit(BuildContext context) async {
    ...
    if (message != 'Account initsuccessfully confirmed!') {
      Scaffold.of(context).showSnackBar(snackBar);
    }
  }
  ...
  submit(BuildContext context) async {
    ...
    try {
      ...
      if (e.code == 'InvalidParameterException' ||
        ...
        message = 'An unknown client error occured' + e.code;
      }
    } catch (e) {
      log(e.toString());
    ...
    if (message != 'User sucessfully logged in!') {
      Scaffold.of(context).showSnackBar(snackBar);
    }
  }
